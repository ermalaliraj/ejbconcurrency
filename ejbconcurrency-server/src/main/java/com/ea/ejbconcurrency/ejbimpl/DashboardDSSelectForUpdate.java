...
public class DashboardDSSelectForUpdate implements DashboardRemote {

	private static final Log log = LogFactory.getLog(DashboardDSSelectForUpdate.class);
	...
	public SegmentDTO addPointToDashboard(String newPoint) throws ServerException {
		...
		try {
			...
			throw new ServerException("General exception while inserting point '" + newPoint + "'", e);
		}
	}
	...
	private String getFirstFreePoint() {
		...
		String sql = "select name from POINT for update";
